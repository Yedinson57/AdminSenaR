...
export default function EnvironmentEdit() {
  ...
  useEffect(() => {
    setFormData((prev) => ({ ...prev, name: prev.name || 'Registro environment #' + id }));
  }, [id]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Actualizar environment', id, formData);
    navigate('/environment');
  };

  return (
    <RequireAuth>
      <FormCard title="Actualizar Ambiente" subtitle="Modifique los datos del registro seleccionado">
