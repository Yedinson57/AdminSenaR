...
export default function ProgramEdit() {
  ...
  useEffect(() => {
    setFormData((prev) => ({ ...prev, name: prev.name || 'Registro program #' + id }));
  }, [id]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Actualizar program', id, formData);
    navigate('/program');
  };

  return (
    <RequireAuth>
      <FormCard title="Actualizar Programa" subtitle="Modifique los datos del registro seleccionado">
